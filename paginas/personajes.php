...
<body>
    ...
    <div class="weapon-grid">
        <div class="weapon-slot"> <img src="../personajes/hero1.webp" alt=""></div>
        <div class="weapon-slot"> <img src="../personajes/hero2.webp" alt=""></div>
        <div class="weapon-slot"> <img src="../personajes/hero3.webp" alt=""></div>
        <div class="weapon-slot"> <img src="../personajes/hero4.webp" alt=""></div>
        <div class="weapon-slot"> <img src="../personajes/hero5.webp" alt=""></div>
        <div class="weapon-slot"> <img src="../personajes/hero6.webp" alt=""></div>
